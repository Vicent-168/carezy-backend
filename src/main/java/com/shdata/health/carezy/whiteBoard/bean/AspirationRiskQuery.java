 ...
 * 老年人误吸
 */
@Component("AspirationRiskQuery")
public class AspirationRiskQuery extends BaseQuery{
    @Resource
    ...
    public Map<String, String> queryXmzs(String yljgid, Date rq, List<String> wardIds) {
        String wsid = formsIndexService.getWsidByylgjAndwsbm2(Constants.LNRWX_WSBM, yljgid);
        if (wsid == null){
            return new HashMap<>();
        }
