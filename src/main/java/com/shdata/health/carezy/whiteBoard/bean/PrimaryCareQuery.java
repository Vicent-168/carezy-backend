 ...
 * 一级护理
 */
@Component("primaryCareQuery")
public class PrimaryCareQuery extends BaseQuery{
    @Resource
    ...
    public Map<String, String> queryXmzs(String yljgid, Date rq, List<String> wardIds) {
        List<RegistInformationVo> list = registInformationMapper.hldjQuery(yljgid, wardIds, Constants.YJHL);
        return list.stream()
