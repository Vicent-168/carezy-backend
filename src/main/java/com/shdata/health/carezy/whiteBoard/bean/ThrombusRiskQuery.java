 ...
 * 血栓风险
 */
@Component("ThrombusRiskQuery")
public class ThrombusRiskQuery extends BaseQuery{
    @Resource
    ...
    public Map<String, String> queryXmzs(String yljgid, Date rq, List<String> wardIds) {
        String wsid = formsIndexService.getWsidByylgjAndwsbm2(Constants.XSFX_WSBM, yljgid);
        if (wsid == null){
            return new HashMap<>();
        }
