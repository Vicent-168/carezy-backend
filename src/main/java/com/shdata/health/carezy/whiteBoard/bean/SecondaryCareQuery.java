 ...
 * 二级护理
 */
@Component(value = "secondaryCareQuery")
public class SecondaryCareQuery  extends BaseQuery{
    @Resource
    ...
    public Map<String, String> queryXmzs(String yljgid, Date rq, List<String> wardIds) {
        List<RegistInformationVo> list = registInformationMapper.hldjQuery(yljgid, wardIds, Constants.EJHL);
        return list.stream()
