 ...
 * 明日出院
 */
@Component("TomorrowOutQuery")
public class TomorrowOutQuery extends BaseQuery{
    @Resource
    ...
    public Map<String, String> queryXmzs(String yljgid, Date rq, List<String> wardIds) {
        ...
        List<RegistInformationVo> list = registInformationMapper.queryTomorrowOut(yljgid, wardIds);
        // 使用Stream API进行分组和转换
        return list.stream()
