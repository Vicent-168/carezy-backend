 ...
 * 气管插管
 */
@Component("trachealIntubationQuery")
public class TrachealIntubationQuery extends BaseQuery {

    @Resource
    private FormsIndexMapper formsIndexMapper;
    @Override
    public Map<String, String> queryXmzs(String yljgid, Date rq, List<String> wardIds) {
        List<RegistInformationVo> list = formsIndexMapper.singleDuctStatistics(yljgid, wardIds, Constants.DGZG_FLDM,Constants.QBCG);
        return list.stream()
